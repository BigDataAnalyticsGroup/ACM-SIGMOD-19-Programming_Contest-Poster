...
\begin{poster}{
    ...
    \headerbox{Ranking}{name=eval,column=3,span=2,below=algo}{
        \textbullet\,preliminary third place
        \textbullet\,best in \emph{Small} with~17\,\% margin
        \textbullet\,best in \emph{Medium} with~12\,\% margin
        \textbullet\,fifth in \emph{Large} with~15\,\% margin
    }
\end{poster}
...
\begin{tikzpicture}[overlay,remember picture]
    \coordinate (arr_task_to_inmemory) at (page cs:0,.33);
    \coordinate (arr_task_to_external) at (page cs:-.20,.265);
