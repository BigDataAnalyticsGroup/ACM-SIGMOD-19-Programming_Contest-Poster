...
\begin{poster}{
    ...
    \headerbox{Ranking}{name=eval,column=0,span=3,below=libs}{
        \begin{itemize}
            ...
            \item best in \emph{Small} (10\,GB) with~17\,\% margin to second
            \item best in \emph{Medium} (20\,GB) with~12\,\% margin to second
...
\begin{tikzpicture}[overlay,remember picture]
    ...
    \coordinate (arr_extern_uses) at (page cs:0,-.33);
